                              ...
                              <form class="form-horizontal" method="get">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Date of birth</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="" data-mask="99/99/9999" class="form-control" name="dob">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Medical Coverage</label>
                                       <div class="col-sm-10">
                                          <input type="text" placeholder="Medical Coverage"  class="form-control" name="med_covrg">
                                        </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Email</label>
                                        <div class="col-sm-10">
                                            <input type="text" placeholder="johndoe@email.com"  class="form-control" name="emp_email">
                                        </div>
                                  </div>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Dacuments One</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="Expire date" data-mask="99/99/9999" class="form-control" name="expire_date">
                                              <span class="help-inline">dd/mm/yyyy</span>
                                        </div>
                                        <div class="col-sm-3">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Dacuments Two</label>
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" placeholder="Expire date" data-mask="99/99/9999" class="form-control" name="expire_date2">
                                              <span class="help-inline">dd/mm/yyyy</span>
                                        </div>
                                        <div class="col-sm-3">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Dacuments Three</label>
                                        <div class="col-sm-3">
                                              <select class="form-control m-bot15" name="doc_type3">
                                                  <option value="0">Health document</option>
                                                  <option value="1">Food Handling certificate</option>
                                                  <option value="2">Identity Card</option>
                                          </select>
